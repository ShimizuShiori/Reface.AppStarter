...
namespace Reface.AppStarter
{
    ...
    {
        public event EventHandler<ModuleComponentCreatingEventArgs> ComponentCreating;
        ...
        private void Registration_Activating(object sender, ActivatingEventArgs<object> e)
        {
            ...
            ModuleComponentCreatingEventArgs moduleComponentCreatingEventArgs =
                new ModuleComponentCreatingEventArgs(new ComponentContextComponentFactory(e.Context), serviceType, e.Instance);
